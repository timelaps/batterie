...
function run(next) {
    ...
    function logError(e) {
        batterie.write('errors', true, e && e.stack ? e.stack : (new Error()).stack);
    }
    ...
    function finished(err) {
        ...
        it.end = now();
        clearTimeout(id);
        it.errorValue = err === undefined ? null : err;
        it.failed = it.errorValue !== null;
...
function checkCounters(batterie, it) {
    var msd, expectations, totalExpectations, actualexpectations;
